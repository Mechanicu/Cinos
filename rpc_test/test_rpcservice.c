...
int main(int argc, char **argv)
{
    ...
    LOG_DEBUG("RPC SERVICE register, server_id:%lx, service_id:%lx, self:%lx", service_id, service->server_id, pthread_self());
    ...
    LOG_DEBUG("RPC client get_service, service_cap:%lx", rpc_client->service_cap);
